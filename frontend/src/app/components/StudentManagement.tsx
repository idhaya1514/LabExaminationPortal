...
const inputCls =
  "w-full px-3.5 py-2.5 rounded-xl text-sm transition-all outline-none";
const inputStyle = {
  background: "#ffffff",
...
export default function StudentManagement({ onBack }: StudentManagementProps) {
  ...
  const handleSubmit = async () => {
    if (
      ...
      !formData.department ||
      !formData.email.trim() ||
      !formData.leetCodeUsername.trim()
    ) {
      toast.warning(
        "Please fill in all required fields including Email and LeetCode Username",
      );
      return;
    }
    setIsSaving(true);
  ...
  const handleAssignQuestion = async () => {
    ...
    try {
      await assignQuestion(
        selectedStudentForAssign.registerNumber,
        selectedQuestionId,
      );
      toast.success(`Question assigned to ${selectedStudentForAssign.name}`);
  ...
  const getIS = (field: string) =>
    focusedField === field ? { ...inputStyle, ...inputFocusStyle } : inputStyle;
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-5">
        {/* ── Top Header & Stats ── */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          {/* Top stripe */}
          <div
            style={{
              height: "4px",
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs mt-0.5" style={{ color: "#94a3b8" }}>
                      Manage student profiles and LeetCode connections
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* ── Add / Edit Form ── */}
        {isAdding && (
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mt-6">
            <div
              style={{
                height: "3px",
            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Field label="LeetCode Username / URL" icon={Code2}>
                  <input
                    ...
                    placeholder="e.g., anitha or leetcode.com/u/anitha"
                    className={inputCls}
                    style={getIS("lc")}
                    onFocus={() => setFocusedField("lc")}
                    onBlur={() => setFocusedField(null)}
                  />
                </Field>
              </div>
              ...
              >
                ...
                <button
                  onClick={resetForm}
                  className="flex items-center gap-2 font-semibold py-2.5 px-5 rounded-xl text-sm transition-all"
                  style={{
                    background: "#f8fafc",
                    color: "#64748b",
                    border: "1.5px solid #e2e8f0",
        ...
        {/* ── Students Table ── */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden mt-6 border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          {/* Table header bar */}
          <div
          ...
          >
            ...
            {searchTerm && (
              <p className="text-xs" style={{ color: "#94a3b8" }}>
                Showing results for "
                <span style={{ color: "#4f46e5" }}>{searchTerm}</span>"
              </p>
            )}
          </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredStudents.map((student, idx) => {
                    const meta =
                      DEPT_META[student.department] ||
                      DEPT_META["Computer Science"];
                    return (
                      <tr
                        key={student.id}
                      ...
                      >
                        ...
                        <td
                          className="px-5 py-4 text-sm font-mono font-semibold"
                          style={{ color: "#475569" }}
                        >
                        ...
                        <td className="px-5 py-4">
                          {student.leetCodeUsername ? (
                            ...
                            >
                              <Code2 className="w-3 h-3" /> View Profile{" "}
          ...
          >
            <p className="text-xs" style={{ color: "#94a3b8" }}>
              {students.length} student{students.length !== 1 ? "s" : ""} — data
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: "#94a3b8" }}>
                    to {selectedStudentForAssign?.name} (
                    {selectedStudentForAssign?.registerNumber})
                  </p>
                </div>
                <button
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={isAssigning || !selectedQuestionId}
