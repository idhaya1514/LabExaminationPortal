...
const PROGRAMMING_QUOTES = [
  ...
  {
    quote:
      "Programs must be written for people to read, and only secondarily for machines to execute.",
...
export default function Dashboard({
  ...
  const handleStreak = () => {
    ...
    if (!stored) {
      localStorage.setItem(
        key,
        JSON.stringify({ streak: 1, lastLoginDate: today }),
      );
      setStreak(1);
      return;
    }
    ...
    try {
      ...
      if (lastLoginStr === today) {
        ...
        localStorage.setItem(
          key,
          JSON.stringify({ streak: newStreak, lastLoginDate: today }),
        );
        setStreak(newStreak);
      } else {
        localStorage.setItem(
  ...
  const loadQuestions = async () => {
    ...
    try {
      ...
      if (!q || q.length === 0) {
        try {
          const { default: defaultQs } =
            await import("../data/default_questions.json");
          if (defaultQs && defaultQs.length > 0) {
            localStorage.setItem(
              "exam_portal_questions",
              JSON.stringify(defaultQs),
            );
            q = defaultQs as any;
            console.log(
              "Seeded",
              defaultQs.length,
              "questions into localStorage",
            );
          }
        } catch (seedErr) {
  ...
  const handleGetRandomQuestion = async () => {
    ...
    try {
      ...
      const previouslyAttemptedTitles = new Set(
        examResults.map((r) => r.question),
      );
  ...
  const diff = selectedQuestion
    ? DIFF_COLORS[selectedQuestion.difficulty]
    : null;
  ...
  const avgExamScore =
    examResults.length > 0
      ? Math.round(
          examResults.reduce((acc, r) => acc + (r.totalMarks || 0), 0) /
            examResults.length,
        )
      : 0;
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-50 font-sans text-slate-700">
      {/* 1. LEFT SIDEBAR */}
      <aside
        className="w-[260px] flex flex-col justify-between py-7 px-5 flex-shrink-0 text-slate-400"
        style={{
          background: "linear-gradient(180deg, #0c0f1d 0%, #1a1836 100%)",
      ...
      >
        <div className="space-y-7">
          ...
          <nav className="space-y-1">
            <p className="text-[9px] font-bold text-slate-600 uppercase tracking-[0.15em] px-3 mb-3">
              Workspace
            </p>
            {[
              {
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    className={`w-[18px] h-[18px] transition-transform duration-300 ${isActive ? "" : "group-hover:scale-110"}`}
                  />
                  {item.label}
                </button>
              );
      ...
      >
        ...
        <header className="h-16 border-b border-slate-200 bg-white/85 backdrop-blur-xl px-8 flex items-center justify-between flex-shrink-0 sticky top-0 z-30">
          <div>
            ...
            <p
              className="text-[11px] font-medium mt-0.5 hidden sm:block"
              style={{ color: "#64748b" }}
            >
              {student.department}
            </p>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="relative z-10">
                    <span className="bg-white/10 px-3 py-1 rounded-full text-[9px] font-black tracking-widest uppercase text-indigo-200 border border-white/5 backdrop-blur-md">
                      Active Student Workspace
                    </span>
                    <h2 className="text-3xl font-black mt-3 mb-1 tracking-tight">
                      Welcome, {student.name}! 👋
                    </h2>
                    <p className="text-xs text-indigo-100 font-medium max-w-xl leading-relaxed mt-1">
                      Access code compiler evaluations, mock vivas, and track
                      your daily LeetCode coding logs with circular milestones.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div
                    style={cardStyles}
                    className="lg:col-span-2 flex flex-col justify-between relative overflow-hidden hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
                  >
                    ...
                    <blockquote className="my-auto">
                      <p className="text-sm font-semibold italic leading-relaxed text-slate-800">
                        ...
                        {
                          PROGRAMMING_QUOTES[
                            new Date().getDate() % PROGRAMMING_QUOTES.length
                          ].quote
                        }
                        "
                      </p>
                  ...
                  <div
                    style={cardStyles}
                    className="flex flex-col justify-between hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
                  >
                    <div>
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  ...
                                  (138 *
                                    Math.min(
                                      50,
                                      leetStats ? leetStats.easySolved : 0,
                                    )) /
                                    50
                                }
                                strokeLinecap="round"
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  ...
                                  (138 *
                                    Math.min(
                                      30,
                                      leetStats ? leetStats.mediumSolved : 0,
                                    )) /
                                    30
                                }
                                strokeLinecap="round"
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  ...
                                  (138 *
                                    Math.min(
                                      10,
                                      leetStats ? leetStats.hardSolved : 0,
                                    )) /
                                    10
                                }
                                strokeLinecap="round"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div
                    style={cardStyles}
                    className="flex flex-col justify-between relative overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl hover:shadow-indigo-500/[0.06] hover:border-indigo-500/30 cursor-default"
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      {leetStats && (
                        <div
                          className="mt-5 pt-4 flex items-center gap-3 text-[11px] font-semibold"
                  ...
                  <div
                    style={cardStyles}
                    className="flex flex-col justify-between relative overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl hover:shadow-blue-500/[0.06] hover:border-blue-500/30 cursor-default"
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div
                        className="mt-5 pt-4 flex items-center justify-between text-[11px] font-semibold"
                        style={{
                  ...
                  <div
                    style={cardStyles}
                    className="flex flex-col justify-between relative overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl hover:shadow-rose-500/[0.06] hover:border-rose-500/30 cursor-default"
                  >
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-5">
                        <div
                          className="p-3 rounded-2xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-300"
                          style={{
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    <div
                      style={cardStyles}
                      className="h-full flex flex-col justify-between hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
                    >
                      <div>
                        <h3
                          className="text-xs font-bold uppercase tracking-wider mb-4 flex items-center gap-1.5 pb-2"
                          style={{
                            color: "#4f46e5",
                        ...
                        {examResults.length === 0 ? (
                          <div
                            className="py-12 text-center text-xs font-semibold"
                            style={{ color: "#64748b" }}
                          >
                          ...
                          <div className="space-y-4 max-h-[220px] overflow-y-auto pr-1">
                            {examResults.slice(0, 5).map((res, index) => {
                              const isPassed =
                                res.status === "Passed" ||
                                (res.totalMarks && res.totalMarks >= 50);
                              const isMalpractice =
                                res.status &&
                                res.status
                                  .toLowerCase()
                              ...
                              return (
                                <div
                                  key={index}
                                  className="flex gap-3 items-start pl-3 relative ml-2"
                                  style={{
                                    borderLeft:
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                      ...
                      <p
                        className="text-xs mt-1 font-semibold opacity-85"
                        style={{
                          color:
                            (selectedQuestion ||
                ...
                {hasSubmittedToday ? (
                  <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-0 rounded-full border-2 border-emerald-500 opacity-20"
                    ...
                    <p className="text-sm text-slate-500 mb-8 max-w-sm">
                      Excellent work! Your lab examination has been successfully
                      recorded for today.
                    </p>

                    <div
                      className="w-full max-w-sm rounded-2xl p-6 mb-8 relative overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      <p className="text-xs font-bold text-emerald-700 uppercase tracking-widest mb-1 relative z-10">
                        Total Score
                      </p>
                      <p
                        className="text-6xl font-black text-emerald-650 relative z-10"
                        style={{ color: "#059669" }}
                      >
                        {(todayResult?.programmingMarks || 0) +
                          (todayResult?.mcqMarks || 0) +
                          (todayResult?.observationMarks || 0)}
                        <span className="text-3xl font-bold opacity-45">
                          /{todayResult?.maxMarks || 50}
                        </span>
                      </p>
                    </div>
                      ...
                      {availableQuestions.length === 0 && !isLoading ? (
                        <div className="text-center py-10">
                          ...
                          <p className="text-sm text-slate-500 mt-2">
                            Waiting for administrator to add questions.
                          </p>
                        </div>
                      ) : isQuestionLoading ? (
                        <div className="text-center py-10">
                        ...
                        <div className="text-center max-w-md mx-auto py-10">
                          <div
                            className="w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 transform rotate-3"
                            style={{
                              background: "rgba(99,102,241,0.05)",
                              border: "1px solid rgba(99,102,241,0.15)",
                            }}
                          ...
                          <p className="text-sm text-slate-500 mb-8 leading-relaxed">
                            Click below to receive your randomly assigned
                            question. Note that you will only receive ONE
                            question and it cannot be changed.
                          </p>
                          <button
                        ...
                        <div className="space-y-6">
                          ...
                          >
                            <div className="flex justify-between items-start mb-4 gap-4">
                              ...
                              <div className="flex gap-2">
                                ...
                                <span
                                  className="px-3 py-1 rounded-lg text-xs font-black uppercase tracking-wider font-mono"
                                  style={{
                          ...
                          >
                            <h4 className="text-xs font-black uppercase tracking-widest mb-3 flex items-center gap-2">
                              <AlertCircle className="w-4 h-4" /> Rules of
                              conduct
                            </h4>
                            <ul className="space-y-2 text-sm font-medium">
                              <li className="flex gap-2">
                                <span>•</span> 30 Marks for code execution, 20
                                Marks for MCQ.
                              </li>
                              <li
                                className="flex gap-2 text-red-650 font-bold"
                                style={{ color: "#dc2626" }}
                              >
                                <span>•</span> ⚠ DO NOT SWITCH TABS. Your exam
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{ color: "#334155" }}
                      >
                        {student.leetCodeUsername || "Not Linked"}
                      </span>
                    </p>
                  </div>
                  {student.leetCodeUsername && (
                    <button
                      onClick={() =>
                        loadLeetCode(student.leetCodeUsername!, true)
                      }
                ...
                {!student.leetCodeUsername ? (
                  <div className="flex flex-col items-center justify-center py-20 text-center max-w-sm mx-auto">
                    ...
                    <p
                      ...
                      style={{ color: "#64748b" }}
                    >
                      Please request the administrator to add your LeetCode
                      username to your profile registration details to track
                      your stats here.
                    </p>
                  </div>
                ) : leetLoading ? (
                  <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="text-sm font-semibold text-slate-600">
                      Retrieving stats from LeetCode...
                    </p>
                  </div>
                ) : leetStats ? (
                  <div className="space-y-6 relative z-10">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            >
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  251 -
                                  251 *
                                    (leetStats.easySolved /
                                      Math.max(leetStats.totalSolved, 1))
                                }
                                strokeLinecap="round"
                                stroke="currentColor"
                                fill="transparent"
                          ...
                          <div>
                            ...
                            <p className="text-xs text-white/60 mt-1 font-medium">
                              {leetStats.ranking > 0
                                ? `Global Rank: #${leetStats.ranking.toLocaleString()}`
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {/* Easy Card */}
                      <div
                        className="group relative bg-white border border-emerald-250 rounded-2xl p-5 hover:-translate-y-1 hover:shadow-lg hover:shadow-emerald-500/[0.06] transition-all duration-400 overflow-hidden cursor-default"
                      ...
                      >
                          ...
                          <div className="relative w-12 h-12 flex items-center justify-center">
                            <svg className="w-full h-full transform -rotate-90">
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  113 -
                                  113 * Math.min(1, leetStats.easySolved / 50)
                                }
                                strokeLinecap="round"
                                stroke="currentColor"
                                fill="transparent"
                            ...
                            <span className="absolute text-[9px] font-extrabold text-emerald-600">
                              {Math.round(
                                (leetStats.easySolved /
                                  Math.max(leetStats.totalSolved, 1)) *
                                  100,
                        ...
                        <div className="mt-3 w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, (leetStats.easySolved / 50) * 100)}%`,
                            }}
                          />
                        </div>
                        <p className="text-[10px] text-slate-500 font-medium mt-1.5">
                          Target: {leetStats.easySolved} / 50 problems completed
                        </p>
                      </div>

                      {/* Medium Card */}
                      <div
                        className="group relative bg-white border border-amber-250 rounded-2xl p-5 hover:-translate-y-1 hover:shadow-lg hover:shadow-amber-500/[0.06] transition-all duration-400 overflow-hidden cursor-default"
                      ...
                      >
                          ...
                          <div className="relative w-12 h-12 flex items-center justify-center">
                            <svg className="w-full h-full transform -rotate-90">
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  113 -
                                  113 * Math.min(1, leetStats.mediumSolved / 30)
                                }
                                strokeLinecap="round"
                                stroke="currentColor"
                                fill="transparent"
                            ...
                            <span className="absolute text-[9px] font-extrabold text-amber-600">
                              {Math.round(
                                (leetStats.mediumSolved /
                                  Math.max(leetStats.totalSolved, 1)) *
                                  100,
                        ...
                        <div className="mt-3 w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, (leetStats.mediumSolved / 30) * 100)}%`,
                            }}
                          />
                        </div>
                        <p className="text-[10px] text-slate-500 font-medium mt-1.5">
                          Target: {leetStats.mediumSolved} / 30 problems
                          completed
                        </p>
                      </div>
                      ...
                      {/* Hard Card */}
                      <div
                        className="group relative bg-white border border-rose-250 rounded-2xl p-5 hover:-translate-y-1 hover:shadow-lg hover:shadow-rose-500/[0.06] transition-all duration-400 overflow-hidden cursor-default"
                      ...
                      >
                          ...
                          <div className="relative w-12 h-12 flex items-center justify-center">
                            <svg className="w-full h-full transform -rotate-90">
                              ...
                              <circle
                                ...
                                strokeDashoffset={
                                  113 -
                                  113 * Math.min(1, leetStats.hardSolved / 10)
                                }
                                strokeLinecap="round"
                                stroke="currentColor"
                                fill="transparent"
                            ...
                            <span className="absolute text-[9px] font-extrabold text-rose-600">
                              {Math.round(
                                (leetStats.hardSolved /
                                  Math.max(leetStats.totalSolved, 1)) *
                                  100,
                        ...
                        <div className="mt-3 w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, (leetStats.hardSolved / 10) * 100)}%`,
                            }}
                          />
                        </div>
                        <p className="text-[10px] text-slate-500 font-medium mt-1.5">
                          Target: {leetStats.hardSolved} / 10 problems completed
                        </p>
                      </div>
                    </div>
                    ...
                    <div style={cardStyles} className="!p-0 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold uppercase tracking-wider text-slate-805">
                            Activity Calendar
                          </span>
                        </div>
                    ...
                    {/* Daily Tip Banner */}
                    <div
                      className="rounded-2xl p-5 flex gap-4 items-start border relative overflow-hidden"
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h4 className="text-xs font-bold tracking-wide mb-0.5 text-orange-700">
                          Daily Challenge Reminder
                        </h4>
                        <p className="text-xs leading-relaxed font-medium text-orange-800">
                          Solve at least one problem daily on LeetCode to
                          maintain your streak. Your progress syncs
                          automatically.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in max-w-sm mx-auto">
                    ...
                    >
                      {leetError ||
                        "We were unable to communicate with LeetCode. Please check your registered username and try again."}
                    </p>
                    <button
                      onClick={() =>
                        loadLeetCode(student.leetCodeUsername!, true)
      ...
      {showProfileModal && (
        <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm z-50 flex justify-end animate-fade-in">
          ...
          <div
            className="w-full max-w-[420px] h-full shadow-2xl relative flex flex-col animate-slide-in-right"
            style={{
              background: "#ffffff",
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 px-7 pt-6 pb-8">
                <div className="flex items-center justify-between mb-6">
                  <span className="bg-white/10 px-3 py-1 rounded-full text-[9px] font-bold tracking-widest uppercase text-indigo-200 border border-white/[0.08]">
                    Student Profile
                  </span>
                  <button
                    onClick={() => setShowProfileModal(false)}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-medium text-indigo-300/80 mt-0.5">
                      {student.registerNumber}
                    </p>
                  </div>
                </div>
            ...
            <div className="flex-grow overflow-y-auto">
              <div className="px-7 py-6 space-y-6">
                ...
                <div className="space-y-1">
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-[0.15em] mb-3">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div
                      className="border rounded-2xl p-3.5 text-center group transition-all duration-300"
                      style={{
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-sm font-bold text-slate-700">
                          {leetStats.totalSolved} Total Solved
                        </span>
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          {
                            label: "Medium",
                            solved: leetStats.mediumSolved || 0,
                            target: 30,
                            color: "amber",
                            barColor: "amber-500",
                          },
                          ...
                          <div key={item.label}>
                            ...
                            <div className="w-full h-1.5 rounded-full overflow-hidden bg-slate-100">
                              <div
                                className={`h-full rounded-full transition-all duration-700 bg-${item.barColor}`}
                                style={{
                                  width: `${Math.min(100, (item.solved / item.target) * 100)}%`,
                                }}
                              />
                            </div>
                          </div>
            ...
            {/* Footer */}
            <div
              className="px-7 py-4 border-t flex-shrink-0"
              style={{
