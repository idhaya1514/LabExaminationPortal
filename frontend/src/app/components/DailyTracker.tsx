  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        {/* ─── Header ─────────────────────────────────────────────── */}
        <div
          className="rounded-2xl overflow-hidden mb-6 animate-fade-in"
          style={{
            background: "#ffffff",
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: "#94a3b8" }}>
                    Monitor which students complete tests each day
                  </p>
                </div>
              </div>
                ...
                },
                {
                  label:
                    trackerType === "exam"
                      ? "Monthly Submissions"
                      : "Monthly Solved Logs",
                  value: monthlyStats.totalSubmissions,
                  color: "#059669",
                ...
                },
                {
                  label:
                    trackerType === "exam"
                      ? "Today's Completed"
                      : "Today's Active",
                  value: activeMap[todayKey]?.size || 0,
                  color: "#0ea5e9",
        ...
        <div
          className="flex p-1 rounded-xl mb-5 max-w-xs"
          style={{
            background: "#ffffff",
            border: "1px solid #e2e8f0",
        ...
        >
          ...
          <button
            onClick={() => setTrackerType("leetcode")}
            className="flex-1 py-2 text-xs font-bold rounded-lg transition-all"
            style={
              trackerType === "leetcode"
                ? {
                                  ...
                                  <div className="flex items-center gap-3 text-right">
                                    <div>
                                      <div className="flex flex-col items-end">
                                        ...
                                        <p
                                          className={`text-sm font-bold ${result.malpractice ? "text-red-600" : "text-emerald-600"}`}
                                        >
              ...
              <table className="w-full">
                <thead>
                  <tr style={{ borderBottom: "1px solid rgba(15,23,42,0.05)" }}>
                    <th
                      className="sticky left-0 z-10 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider min-w-[200px] border-r border-slate-200"
                      style={{ background: "#f8fafc", color: "#4f46e5" }}
                    >
                      Student
                    </th>
                    <th
                      className="sticky left-[200px] z-10 px-2 py-3 text-center text-xs font-semibold uppercase tracking-wider min-w-[55px] border-r border-slate-200"
                      style={{ background: "#f8fafc", color: "#4f46e5" }}
                    >
                      Total
                    </th>
                    ...
                    filteredStudents.map((student) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            className="sticky left-[200px] z-10 px-2 py-2.5 text-center border-r border-slate-200"
                            style={{ background: "#ffffff" }}
                          >
                            <span
