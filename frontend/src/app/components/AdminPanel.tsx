...
const card =
  "bg-white/80 backdrop-blur-xl border border-white/50 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)]";
...
export default function AdminPanel({
  ...
  const handleDeleteResult = async (id: number | string) => {
    if (
      confirm(
        "Are you sure you want to delete this specific student's attempt?",
      )
    ) {
      try {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans p-4 md:p-6 selection:bg-indigo-100 selection:text-indigo-900">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ── Top Nav ── */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-5 animate-fade-in overflow-hidden relative">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-tr from-indigo-600 to-purple-600 shadow-lg shadow-indigo-200">
                <Shield className="w-5 h-5 text-white" />
              </div>
              <div>
                <h1 className="text-base font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-700 to-purple-700">
                  Admin Dashboard
                </h1>
                <p className="text-xs text-slate-500 font-medium">
                  SSCET Examination System
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {[
                { label: "Staff", icon: Users, action: onManageStaff },
                { label: "Students", icon: UserPlus, action: onManageStudents },
                {
                  label: "Questions",
                  icon: BookOpen,
                  action: onManageQuestions,
                },
                {
                  label: "Performance",
                  icon: BarChart2,
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
          {[
            ...
            <div
              key={label}
              className={`${card} p-5 animate-fade-in hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300`}
            >
              ...
              <p className="text-2xl font-bold mb-0.5 text-slate-800 animate-fade-in tracking-tight">
                {value}
              </p>
