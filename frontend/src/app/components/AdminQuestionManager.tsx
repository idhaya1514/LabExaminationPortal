...
export default function AdminQuestionManager({
  ...
  const handleSeed = async () => {
    if (
      !confirm(
        "Are you sure you want to seed the 100 default basic programming questions (25 C, 25 Java, 25 Python, 25 JS)? This will replace any existing questions.",
      )
    ) {
      return;
    }
  ...
  const handleExportJSON = () => {
    try {
      ...
      toast.success(
        "Successfully exported questions to default_questions.json!",
      );
    } catch (err: any) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        {/* ── Header ── */}
        <div
          className="rounded-2xl overflow-hidden mb-5 animate-fade-in"
          style={{
            background: "#ffffff",
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: "#94a3b8" }}>
                  Manage programming questions & MCQs
                </p>
              </div>
            </div>
            {!isAdding && (
